...
<head>
    ...
    <title>Virtual Personal Server & AI Robotrade KITARO ANGEL - ver 1.0</title>
    <!-- CSS only -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center bg-blue py-3 mb-2">
                    ...
                    <h2 class="py-0 lh-1">Virtual Personal Server & AI Robotrade KITARO ANGEL</h2>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <ol class="aplha">
                        <li class="mb-2">
                           <p> Dengan menandatangani Formulir Permohonan Sewa Guna Bersama ini, maka saya menyatakan telah sepenuhnya mengerti maksud dan
                            ...
                            nya memahami bahwa hasil masa lalu tidak senantiasa mencerminkan hasil yang akan diperoleh di masa kini dan masa mendatang</p>
                        </li>
                        <li class="mb-2">
                            <p>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-4">
                                    <div class="border text-center">
                                        <div class="bg-blue  py-1">
                                            <b>Nama Paket Sewa yang dipilih</b>
                                        </div>
                                        <div class="py-1">

                                            <h4><?php echo  $this->model->select("name", "kitaro_vps", "unit <= " . $transaction['unit'] . " ORDER BY unit DESC LIMIT 1"); ?> </h4>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 mt-1">
                                    ...
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><strong> <?php echo number_format($transaction['unit']); ?> UNIT </strong> </td>
                                        </tr>
                                        <tr>
                                            <td> C. Total Biaya Sewa (USD 125,- per unit Robotrade K-ANGEL) </td>
                                            <td class="text-center"><strong> USD <?php echo number_format($transaction['totalUsd']); ?></strong> </td>
                                        </tr>

                                        <tr>
                                            <td class="text-center">
                                                <strong>TOTAL JUMLAH PEMBAYARAN </strong> (Kurs 1 USD = IDR <?php echo number_format($transaction['currency']); ?>,-)
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center p-0 m-0 lh-1">
                                                <small class="font1">Total Transfer Pembayaran via Bank (dalam mata uang Rupiah)</small>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <b>IDR <?php echo number_format($transaction['grandTotal']); ?></b>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <div class="f01">* Bukti Transfer Bank & fotocopy KTP dikirimkan terlebih dahulu beserta scan Formulir ini ke : customer.kitaro@gmail.com
                                    </div>
                                </div>
                            </div>
